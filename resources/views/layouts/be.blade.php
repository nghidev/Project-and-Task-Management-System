...
<head>
    ...
    <style>
        ...
        .project-title {
            ...
            max-width: 100%;
            /* Điều chỉnh độ rộng tối đa tùy theo layout */
        }
    ...
    @if (Auth::user())
        <header id="header" class="header fixed-top d-flex align-items-center">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <a href="{{ route('admin') }}" class="logo d-flex align-items-center">
                    ...
                    <span class="d-none d-lg-block">TaskManagement</span>
                </a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img src="be/img/messages-1.jpg" alt="" class="rounded-circle">
                                    <div>
                                        <h4>Maria Hudson</h4>
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img src="be/img/messages-2.jpg" alt="" class="rounded-circle">
                                    <div>
                                        <h4>Anna Nelson</h4>
                                        <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                        <p>6 hrs. ago</p>
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img src="be/img/messages-3.jpg" alt="" class="rounded-circle">
                                    <div>
                                        <h4>David Muldon</h4>
                                        <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                        <p>8 hrs. ago</p>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                <li class="nav-heading">các không gian làm việc </li>
                @if (Auth::user()->role === 1)
                    <li class="nav-item">
                    ...
                    <li class="nav-heading">Quản lý</li>
                    <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse"
                        href="#">
                        <i class="bi bi-layout-text-window-reverse"></i><span>Tạo</span><i
                            class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="{{ route('units.create') }}">
                                <i class="bi bi-circle"></i><span>Tạo không gian làm việc</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('projects.create') }}">
                                <i class="bi bi-circle"></i><span>Tạo project</span>
                            </a>
                        </li>
                    </ul>
                    </li><!-- End Tables Nav -->
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="{{ route('profile.index') }}">
                            <i class="bi bi-person"></i>
                            <span>Quản lý hồ sơ</span>
                        </a>
                    </li>
                    {{-- <li class="nav-item">
                        <a class="nav-link collapsed" href="{{ route('profile.assignmentindex') }}">
                            <i class="bi bi-person"></i>
                            <span>Chỉ định huấn luyện</span>
                        </a>
                    </li> --}}
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse"
                            ...
                            <i class="bi bi-journal-text"></i><span>Quả lý quyền và người dùng</span><i
                                class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <ul id="forms-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav"
                            ...
                            <li>
                                <a href="forms-elements.html">
                                    <i class="bi bi-circle"></i><span>Quyền truy cập</span>
                                </a>
                            </li>
                            <li>
                                <a href="forms-layouts.html">
                                    <i class="bi bi-circle"></i><span>Quản lý hồ sơ</span>
                                </a>
                            </li>
                ...
                @else
                    ...
                    {{-- <li class="nav-item">
                            <a class="nav-link collapsed" href="{{ route('coach.listusers') }}">
                            <i class="bi bi-person"></i>
                            <span>Chỉ định huấn luyện</span>
                            </a>
                        </li> --}}
